    ...
    <div className=" w-[100%] h-full flex flex-col items-start justify-center gap-5 ">
      ...
      <section className=" w-full flex flex-col gap-[15px] md:gap-[20px] ">
        ...
        <div className=" flex items-center gap-[20px]">
          <button className="px-[20px] text-[14px] cursor-pointer hover:from-tertiary/80 hover:to-tertiary-foreground/80 transition ease-in-out py-[10px] border border-border rounded-lg text-white font-medium bg-gradient-to-r from-tertiary to-tertiary-foreground">
            Create Token
          </button>
          <button className="px-[20px] text-[14px] cursor-pointer hover:bg-primary/10 py-[10px] border border-border rounded-lg text-primary font-medium bg-secondary ">
            Browse tools
          </button>
        </div>
      </section>
  ...
  return (
    <div className="hidden w-full h-full lg:flex items-center justify-end  ">
      <section className=" h-fit grid grid-cols-2 items-center gap-[20px] justify-items-end" >
        ...
        <img src={banner3} loading="lazy" className="rounded-lg border border-border col-start-2 hover-scale shadow-glow brightness-110 contrast-105 saturate-125 " />
      </section>
    </div>
  );
});
